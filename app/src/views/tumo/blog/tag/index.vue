<template>
  <div class="app-container">
      ...
      <el-col :span="6">
        <el-card shadow="never">
          <el-form size="mini" :inline="true">
            <el-form-item>
              <el-input v-model="query.name" placeholder="请输入标签内容查询" />
            </el-form-item>
    ...
    <model :form="form" @modelOpen="handleSubmit" :dialogVisible="dialogVisible"></model>
  </div>
</template>

<script>
import { getTagFilterList, getTagById, tagUpdate, tagAdd, tagDel } from '@/api/tag'
import { findByTag } from '@/api/article'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      getTagFilterList(this.query).then(res => {
        if (res.code === 200) {
          this.list = res.data
        } else {
